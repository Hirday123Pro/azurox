...
export const SEED_ASSETS: Asset[] = [
  ...
  },
  {
    ...
    dollar_price: null,
    price_display: 'Robux',
    creator: 'Kairo Systems',
    tags: ['combat', 'systems', 'server'],
    category: 'Scripts',
    image_urls: [],
    discord_link: 'https://discord.gg/azurox',
  ...
  },
  {
    ...
    price_display: 'USD',
    creator: 'Azurox Studio',
    tags: ['interface', 'missions', 'narrative'],
    category: 'UI',
    image_urls: [],
    discord_link: 'https://discord.gg/azurox',
